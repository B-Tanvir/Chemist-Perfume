                ...
                <div className="container m-auto space-y-6 text-gray-600">
                    ...
                    <div className="w-max m-auto flex items-center justify-between space-x-4">
                        <a href="tel:+243996660436" aria-label="call">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 m-auto"
                                 viewBox="0 0 16 16">
                    ...
                    <div className="text-center">
                        <span className="text-sm tracking-wide">Copyright © Home <span id="year"></span> | All right reserved</span>
                    </div>
                </div>
            </div>
        </footer>
